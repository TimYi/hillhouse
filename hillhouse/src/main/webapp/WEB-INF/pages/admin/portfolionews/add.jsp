...
<form role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="author" placeholder="please input author">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="origion" class="col-sm-2 control-label">origion:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="origion" placeholder="please input origion">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="link" class="col-sm-2 control-label">link:</label>
                        <div class="col-sm-10">
                            <input type="url" class="form-control" name="link" placeholder="please input link">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="linkShorthand" class="col-sm-2 control-label">linkShorthand:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="linkShorthand" placeholder="please input linkShorthand">
                        </div>
                    </div>
                    <div class="form-group">
